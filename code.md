...
###############################
Label(root, text='-' * 30).grid(row = 0, column = 0, columnspan = 5)
...
#
lbl2.grid(row=3, column=0, columnspan = 5)
en4.grid(row=4, column=1)
en5.grid(row=6, column=1)
en6.grid(row=5, column=1)
en7.grid(row=5, column=0)
btn2.grid(row = 5, column = 3)
lbl3.grid(row = 4, column = 4)
lbl4.grid(row = 6, column =4)
Label(root, text='---------').grid(row = 5, column = 4)
##
lbl2_1.grid(row = 7, column = 0, columnspan = 5)
lbl2_2.grid(row = 9, column = 0)
lbl2_3.grid(row = 9, column = 2)
lbl2_4.grid(row = 8, column = 3)
lbl2_5.grid(row = 10, column = 3)
lbl2_6.grid(row = 9, column = 3)
en2_1.grid(row = 8, column = 0)
en2_2.grid(row = 10, column = 0)
btn2_1.grid(row = 9, column = 1)
###
lbl3_5.grid(row = 11, column = 0, columnspan = 5)
lbl3_1.grid(row = 13, column = 0)
lbl3_2.grid(row = 13, column = 1)
lbl3_3.grid(row = 12, column = 3)
lbl3_4.grid(row = 14, column = 3)
lbl3_6.grid(row = 12, column = 4)
lbl3_7.grid(row = 14, column = 4)
lbl3_8.grid(row = 13, column = 3)
lbl3_9.grid(row = 13, column = 4)
btn3.grid(row = 13, column = 2)
en3_1.grid(row = 12, column = 0)
en3_2.grid(row = 14, column = 0)
en3_3.grid(row = 12, column = 1)
en3_4.grid(row = 14, column = 1)
####
lbl4_1.grid(row = 15, column = 0, columnspan = 5)
lbl4_2.grid(row = 17, column = 0)
lbl4_3.grid(row = 17, column = 2, columnspan = 3)
btn4.grid(row = 17, column = 1)
en4_1.grid(row = 16, column = 0)
en4_2.grid(row = 18, column = 0)
######################################
root.mainloop()
